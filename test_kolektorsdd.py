#!/usr/bin/env python3
"""
Test script for evaluating trained models on KolektorSDD dataset.
"""
...
def parse_args():
    parser = argparse.ArgumentParser(description='Test UNet on KolektorSDD dataset')
...
def main():
    ...
    print("\n" + "="*60)
    print("🚀 KOLEKTORSDD DATASET EVALUATION")
    print("="*60)
    ...
    if hasattr(dataset, 'class_names'):
        ...
        class_names = ['background', 'defect_type_1', 'defect_type_2'][:num_classes]
